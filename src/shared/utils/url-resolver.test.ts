...
const WSL2_BASE = 'file://wsl.localhost/Ubuntu-24.04/home/user/project/markdown-viewer';
...
Deno.test('resolveRelativeLink: 日本語パス', () => {
  ...
  const expected = `${WSL2_BASE}/${encodeURIComponent('ドキュメント')}/${encodeURIComponent('アーキテクチャ.md')}`;
